...
<body>
    ...
    function printRegistration() {
        window.open('print_registration.php?id=<?php echo $registration_id; ?>', '_blank');
    }
    ...
    function sendConfirmation() {
        Swal.fire({
            ...
            text: 'ต้องการส่งอีเมลยืนยันการลงทะเบียนไปยัง <?php echo $registration['email']; ?> ใช่หรือไม่?',
            icon: 'question',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                // ส่ง AJAX request ไปยัง endpoint ที่จัดการการส่งอีเมล
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            Swal.fire({
                                ...
                                text: 'ระบบได้ส่งอีเมลยืนยันไปยัง <?php echo $registration['email']; ?> เรียบร้อยแล้ว',
                                icon: 'success'
                            });
                        } else {
                            Swal.fire({
    ...
    function deleteRegistration() {
        Swal.fire({
            title: 'ยืนยันการลบ',
            text: 'คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลการลงทะเบียนนี้? การดำเนินการนี้ไม่สามารถย้อนกลับได้',
            icon: 'warning',
            showCancelButton: true,
