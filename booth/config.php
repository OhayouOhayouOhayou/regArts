...
function reserveBooth($boothId, $customerName, $customerEmail, $customerPhone, $customerCompany, $conn, $customerAddress, $customerLineId = '') {
    try {
        ...
        writeLog("Customer Address: $customerAddress");
        ...
        $sql = "INSERT INTO orders (order_number, customer_name, customer_email, customer_phone, total_amount, payment_status) VALUES (?, ?, ?, ?, ?, 'unpaid')";
        ...
        $bindResult = $insertOrder->bind_param("ssssd", $orderNumber, $customerName, $customerEmail, $customerPhone, $booth['price']);
        if (!$bindResult) {
